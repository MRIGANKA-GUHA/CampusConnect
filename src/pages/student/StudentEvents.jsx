...
import { Search, X, Calendar, MapPin, Users, Check, Loader2, Image as ImageIcon } from 'lucide-react';
...
export default function StudentEvents() {
  ...
  const [registeredEvents, setRegisteredEvents] = useState([]); // stores registered event IDs
              ...
              >
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col relative z-10">
                  ...
                  {registeredEvents.includes(event.id) ? (
                    <button
                      disabled
                      className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-[1.25rem] font-bold text-sm bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20 transition-all"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-[1.25rem] font-bold text-sm bg-slate-900 text-white dark:bg-white dark:text-black hover:bg-slate-800 dark:hover:bg-slate-200 shadow-lg hover:shadow-slate-500/20 dark:hover:shadow-white/20 transition-all active:scale-95 disabled:opacity-50 disabled:active:scale-100"
                    >
          ...
          <div className="relative bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[2.5rem] shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="p-6 sm:px-8 border-t border-slate-100 dark:border-white/10 shrink-0 bg-slate-50 dark:bg-black/40 z-10">
              {registeredEvents.includes(selectedEvent.id) ? (
                <button
                  disabled
                  className="w-full flex items-center justify-center gap-2 py-3.5 rounded-[1.25rem] font-bold text-sm bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20 transition-all"
                >
                  <Check className="w-4 h-4" />
                  Registered
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 rounded-[1.25rem] font-bold text-sm bg-slate-900 text-white dark:bg-white dark:text-black hover:bg-slate-800 dark:hover:bg-slate-200 shadow-lg hover:shadow-slate-500/20 dark:hover:shadow-white/20 transition-all active:scale-95 disabled:opacity-50 disabled:active:scale-100"
                >
